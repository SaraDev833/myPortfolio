            ...
            <div className='container py-16 mx-auto w-full px-4'>
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="flex items-center justify-center mt-6 gap-4">
                        ...
                        <a href="" target='_blank' className="bg-slate-300 text-slate-800 font-medium py-2 px-4 rounded-lg hover:bg-slate-400 transition duration-300 ease-in-out hover:scale-110"><FaLinkedin /></a>
                    ...
                    <div className="final flex-col flex justify-center items-center mt-3">
                        <p className='text-center font-medium font-Preahvihear text-slate-300'>Feel free to drop me a message anytime—I’m just a click away! You can reach me at <a href="mailto:sksara706@gmail.com" className='text-lightPurple' style={{ textDecoration: 'none' }}>sksara706@gmail.com</a></p>
